...
c
	a_nu_0=4.38
	a_beta_0=0.012
	a_nu=(xk1(i,j)/d1(i,j))*xttg**0.5
	rn=cm*a_nu**3.0*(1.0-(a_nu/a_nu_0))*d1(i,j)**2.0
	rd=(1.0+a_beta_0*a_nu**3.0)*xk1(i,j)
	rr=rn/rd
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc     
c                                               
...
c                                               
     ...
     *         -rr+((d1(i,j)/xk1(i,j))*(c1*GG-c2*d1(i,j))))
c                                               
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c                                               
